...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof particlesJS !== 'undefined') {
        // Configuration pour mobile avec lignes entre particules
        if (isMobile) {
            particlesJS('particles-js', {
                particles: {
                    number: { value: 30, density: { enable: true, value_area: 800 } }, // Nombre de particules réduit mais suffisant
                    color: { value: "#00c2ff" },
                    shape: {
                        type: "circle",
                    ...
                    opacity: {
                        value: 0.5,
                        random: true,
                        anim: { enable: true, speed: 0.5, opacity_min: 0.1, sync: false } // Animation d'opacité activée mais ralentie
                    },
                    size: {
                        value: 2,
                        random: true,
                        anim: { enable: true, speed: 1, size_min: 0.1, sync: false } // Animation de taille activée mais ralentie
                    },
                    line_linked: {
                        enable: true, // Activer les lignes entre particules
                        distance: 120, // Distance réduite
                        color: "#00c2ff",
                ...
                interactivity: {
                    detect_on: "canvas",
                    events: {
                        onhover: { enable: true, mode: "grab" }, // Activer l'interactivité au survol
                        onclick: { enable: true, mode: "push" }, // Activer l'interactivité au clic
                        resize: true
                    },
                    modes: {
                        grab: { distance: 100, line_linked: { opacity: 0.8 } }, // Distance réduite
                        push: { particles_nb: 2 } // Nombre réduit de particules ajoutées
                    }
                },
